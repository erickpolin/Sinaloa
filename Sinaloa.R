...
attach(ConcSinaloa) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcSinaloa<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcSinaloa) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcSinaloa$factor,to.data.frame=TRUE)
...
ConcSinaloa$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcSinaloa$MAXT<-ConcSinaloa$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcSinaloa<-ConcSinaloa[with(ConcSinaloa, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcSinaloa$ACUMULA<-cumsum(ConcSinaloa$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcSinaloa[dim(ConcSinaloa[ConcSinaloa$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcSinaloa<-rbind(ConcSinaloa[1:(dim(ConcSinaloa[ConcSinaloa$ACUMULA<tam_dec*i,])[1]+1),],
                    ConcSinaloa[(dim(ConcSinaloa[ConcSinaloa$ACUMULA<tam_dec*i,])[1]+1):dim(ConcSinaloa[1])[1],])
  
  b1<-tam_dec*i-ConcSinaloa[dim(ConcSinaloa[ConcSinaloa$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcSinaloa[(dim(ConcSinaloa[ConcSinaloa$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcSinaloa[(dim(ConcSinaloa[ConcSinaloa$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcSinaloa$ACUMULA2<-cumsum(ConcSinaloa$factor)
...
ConcSinaloa[(ConcSinaloa$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcSinaloa[((ConcSinaloa$ACUMULA2>tam_dec*i)&(ConcSinaloa$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcSinaloa[ConcSinaloa$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Sinaloa")
write.dbf(ConcSinaloa,file="ConcSinaloa2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Sinaloa")
write.dbf(ConcSinaloa,file="ConcSinaloa2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Sinaloa")
Conc2010<-read.dbf("ConcSinaloa2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Sinaloa por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Sinaloa por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Sinaloa por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Sinaloa por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Sinaloa por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Sinaloa INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Sinaloa INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Sinaloa INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Sinaloa INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Sinaloa INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Sinaloa NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Sinaloa NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Sinaloa NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Sinaloa NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Sinaloa NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Sinaloa")
Conc2018<-read.dbf("ConcSinaloa2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Sinaloa Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Sinaloa Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Sinaloa Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Sinaloa Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Sinaloa Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Sinaloa INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Sinaloa INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Sinaloa INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Sinaloa INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Sinaloa INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Sinaloa NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Sinaloa NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Sinaloa NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Sinaloa NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Sinaloa NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Sinaloa por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Sinaloa Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Sinaloa NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Sinaloa NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Sinaloa INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Sinaloa INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
